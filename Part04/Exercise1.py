...
tracker_type = tracker_types[6] # Only [1], [2], [7] available in vanilla OpenCV, rest except [5] available with Legacy OpenCV
# Best tracker overall: KCF, MOSSE and CSRT 
...
output = cv2.VideoWriter(f'Part04/{tracker_type}.avi', 
